...
function isIconInstance(node) {
    ...
    if ("children" in node && node.children.length > 0) {
        const hasVectorChildren = node.children.some((child) => child.type === "VECTOR" || child.type === "BOOLEAN_OPERATION");
    ...
    if (msg.type === "INSERT_ICON") {
        ...
        (() => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const nodeToReplace = yield figma.getNodeByIdAsync(nodeId);
